...
from falcon_patch import replace_attn_with_flash_attn as replace_falcon_attn_with_flash_attn
from llama_patch import replace_attn_with_flash_attn as replace_llama_attn_with_flash_attn
